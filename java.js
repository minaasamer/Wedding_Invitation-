...
// ================= SMOOTH SCROLL TO BOTTOM (SLOW) =================

let scrollAnimationId = null;

function smoothScrollToBottom(duration = 30000) {

  // لو فيه أنيميشن شغال بنوقفه الأول
  ...
  // Ease in-out عشان يبقى ناعم في البداية والنهاية
...
// لو المستخدم لمس السكرول بإيده، نوقف الأنيميشن فورًا عشان ميبقاش في تصارع
